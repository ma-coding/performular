...
//         const baseClassDescriptors: PropertyDescriptorMap = getAllPropertyDescriptors(
//             baseClass
//         );
//         const descriptors: PropertyDescriptorMap = getAllPropertyDescriptors(
//             mixin
//         );
...
//     return Reflect.ownKeys(object).reduce(
//         (descriptors: any, key: string | number | symbol) => {
